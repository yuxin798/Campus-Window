...
public class UserVo {
    ...
    public UserVo(String userId, String userName, String school, String avatar, double gender, String signature, double loves, double friends, double followers, double fans, String background) {
        this.userId = userId;
