...
public class AmusementItemDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_amusement_item_detail);
        findByView();
    ...
    private void showPopupWindow() {
        //设置contentView
        View contentView = LayoutInflater.from(AmusementItemDetailActivity.this).inflate(R.layout.activity_comment_popup, null);
        ...
        //显示PopupWindow
        View rootview = LayoutInflater.from(AmusementItemDetailActivity.this).inflate(R.layout.activity_academic_item_detail, null);
