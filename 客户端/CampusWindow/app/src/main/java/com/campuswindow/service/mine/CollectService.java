...
public class CollectService {
    ...
    public Result getCollectList(){
        ...
        request = new Request.Builder()
                .url(API.ACTIVITY + "findAllCollectByUserId?userId="+ UserConstant.USER_ID)
                .get()
                .build();
    ...
    public Result getCollectListByUserId(String userId) {
        client = new OkHttpClient();
        request = new Request.Builder()
                .url(API.ACTIVITY + "findAllCollectByUserId?userId=" + userId)
                .get()
                .build();
        call = client.newCall(request);
        try {
