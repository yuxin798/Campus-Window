...
//            chatService.saveForPrivate(userId, toUserId);
//        }
//    }
//
//    public void cancelFollowOtherUser(String userId, String toUserId) {
//        int count1 = followService.findCountByUserIdAndToUserId(userId, toUserId);
//        if (count1 == 2){
//            updateFriendsByUserIdAndToUserId(userId, toUserId, -1);
//            String linkId = chatService.findLinkIdByUserIdAndToUserId(userId, toUserId);
//            chatService.deleteByLinkId(linkId);
//        }
...
//    }
    ...
    public List<FansVo> findFansByUserId(String userId) {
        return userRepository.findFansByUserId(userId)
                .stream()
                .peek(e -> e.setMutualFollow(followService.mutualFollowIsOrNot(userId, e.getUserId())))
                .collect(Collectors.toList());
    }
    ...
    public List<FriendsVo> findFriendsByUserName(String userId, String userName) {
        return userRepository.findFriendsByUserName(userId, userName);
    }

    public List<FollowersVo> findFollowersByUserName(String userId, String userName) {
        return userRepository.findFollowersByUserName(userId, userName)
                .stream()
                .peek(e -> e.setMutualFollow(followService.mutualFollowIsOrNot(userId, e.getUserId())))
                .collect(Collectors.toList());
    }

    public List<FansVo> findFansByUserName(String userId, String userName) {
        return userRepository.findFansByUserName(userId, userName)
                .stream()
                .peek(e -> e.setMutualFollow(followService.mutualFollowIsOrNot(userId, e.getUserId())))
                .collect(Collectors.toList());
    }
