...
public class UserController {
    ...
    @GetMapping("/findFriendsByUserName")
    @Operation(summary = "朋友列表根据用户名查询用户")
    public Result<List<FriendsVo>> findFriendsByUserName(String userId, String userName){
        List<FriendsVo> users = userService.findFriendsByUserName(userId, userName);
        return ResultVOUtil.success(users);
    }
    @GetMapping("/findFollowersByUserName")
    @Operation(summary = "关注列表根据用户名查询用户")
    public Result<List<FollowersVo>> findFollowersByUserName(String userId, String userName){
        List<FollowersVo> users = userService.findFollowersByUserName(userId, userName);
        return ResultVOUtil.success(users);
    }
    @GetMapping("/findFansByUserName")
    @Operation(summary = "粉丝列表根据用户名查询用户")
    public Result<List<FansVo>> findFansByUserName(String userId, String userName){
        List<FansVo> users = userService.findFansByUserName(userId, userName);
        return ResultVOUtil.success(users);
    }
